<template>
  <div
    class="flex h-screen flex-col justify-between border-e w-1/6 bg-gray-50 shadow-md"
  >
    <div class="py-6">
      <div class="mx-4 h-20 place-content-center">
        <img
    ...
    <div class="sticky inset-x-0 bottom-0 border-t border-gray-100">
      <button
        @click="showProfile"
        class="flex items-center w-full text-start gap-2 bg-white p-4 hover:bg-gray-50"
      >
        <img
          alt="Man"
...
export default {
  ...
  methods: {
    showHome() {
      this.$emit('showContent', 'TheDashboard')
    },
    showTryout() {
      this.$emit('showContent', 'TheTryout')
    },
    showNilai() {
      this.$emit('showContent', 'TheScore')
    },
    showRank() {
      this.$emit('showContent', 'TheRank')
    },
    showProfile() {
